...
package GL.Extended is
  ...
  --
  pragma Import (Stdcall, GenBuffers,         "GLee_Lazy_glGenBuffers");
  pragma Import (Stdcall, DeleteBuffers,      "GLee_Lazy_glDeleteBuffers");
  pragma Import (Stdcall, BindBuffer,         "GLee_Lazy_glBindBuffer");
  pragma Import (Stdcall, BufferData,         "GLee_Lazy_glBufferData");
  pragma Import (Stdcall, BufferSubData,      "GLee_Lazy_glBufferSubData");
  pragma Import (Stdcall, MapBuffer,          "GLee_Lazy_glMapBuffer");
  pragma Import (Stdcall, UnmapBuffer,        "GLee_Lazy_glUnmapBuffer");
  pragma Import (Stdcall, GetBufferParameter, "GLee_Lazy_glGetBufferParameteriv");
